...
urlpatterns = [
    ...
    path('api/pdf/get_debit_note_details/<int:debit_id>/', views.get_debit_note_details, name='get_debit_note_details'),
    path('view_template/<int:debit_id>/', views.view_template, name='view_template'),
]
